...
export default function TableEpisodes({ hanleEdit, search }) {
  ...
  const columns = [
    ...
    {
      field: "episodesNumber",
      headerName: "Episodes Number",
      flex: 1,
      headerAlign: "center",
      align: "center",
    },
    {
      ...
      align: "center",
       renderCell: (params) => (
        <h1>{getOjectById(movies,params.value).name}</h1>
       )
    },
    {
      field: "episodesUrl",
      headerName: "episodes Url",
      flex: 1,
      headerAlign: "center",
      align: "center",
    },
  ...
  const dataSearch = useMemo(() => {
    return episodes.filter((e) =>
      e.movieID?.toLowerCase().includes(search.toLowerCase()),
    );
  }, [episodes, search]);
